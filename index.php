...
<body>
    ...
    <h4>Lunghezza testo: <?php echo strlen($text); ?> caratteri</h4>


    <h2>Testo censurato</h2>
    <p>
        <?php echo $textCensura; ?>
    </p>
    <h4>Lunghezza testo: <?php echo strlen($textCensura); ?> caratteri</h4>
